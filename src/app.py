...
logging.info("STARTING NBA ELT PIPELINE SCRIPT Version: 1.4.0")
# logging.warning("STARTING NBA ELT PIPELINE SCRIPT Version: 1.4.0")
# logging.error("STARTING NBA ELT PIPELINE SCRIPT Version: 1.4.0")
...
logging.info("FINISHED NBA ELT PIPELINE SCRIPT Version: 1.4.0")
