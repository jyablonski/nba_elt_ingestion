...
logging.info("STARTING NBA ELT PIPELINE SCRIPT Version: 1.3.2")
# logging.warning("STARTING NBA ELT PIPELINE SCRIPT Version: 1.3.2")
# logging.error("STARTING NBA ELT PIPELINE SCRIPT Version: 1.3.2")
...
logging.info("FINISHED NBA ELT PIPELINE SCRIPT Version: 1.3.2")
